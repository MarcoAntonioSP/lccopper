    ...
    <div className={styles.container}>
      <section className={styles.section}>
        ...
        <div className={styles.info}>
          ...
          <p className={styles.paragraph}>
            <strong>Telefone:</strong> (11) 4676-0398 / 4676-3092<br/>
            <strong>Fax:</strong> (11) 4679-7171<br/>
          ...
          <p className={styles.paragraph}>
            <strong>E-mail:</strong> <a href="mailto:fernando@lccopper.com.br">fernando@lccopper.com.br</a><br/>
            <strong>Site:</strong> <a href="http://www.lccopper.com.br">www.lccopper.com.br</a>
          </p>
        </div>
      </section>
